...
part 'goldens/zodart_cross_field_validators.dart';
...
/// Helper class (normally generated by the pre-type generator)
abstract final class NewClass2 with _N {}

SuperRefinerErrorRes? zStrNotEmpty(ParsedFieldAccessor vals) =>
    (vals['zStr'] as String).isNotEmpty ? null : (const ZIssue.custom(), others: []);

@ShouldGenerateFile(
  'goldens/zodart_cross_field_validators.dart',
  partOfCurrent: true,
)
@ZodArt.generateNewClass(outputClassName: 'NewClass2', crossFieldValidators: [zStrNotEmpty])
abstract class C {
  static final schema = allTypesSchemaDef;
  static const z = _CUtils();
}
