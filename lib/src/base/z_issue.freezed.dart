...
/// @nodoc
class _$ZIssueCopyWithImpl<$Res> implements $ZIssueCopyWith<$Res> {
...
class ZIssueLengthNotMet extends ZIssue {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ZIssueLengthNotMetCopyWith<ZIssueLengthNotMet> get copyWith =>
      _$ZIssueLengthNotMetCopyWithImpl<ZIssueLengthNotMet>(this, _$identity);
...
class ZIssueMinNotMet extends ZIssue {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ZIssueMinNotMetCopyWith<ZIssueMinNotMet> get copyWith =>
      _$ZIssueMinNotMetCopyWithImpl<ZIssueMinNotMet>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ZIssueMinNotMet &&
...
class ZIssueMaxExceeded extends ZIssue {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ZIssueMaxExceededCopyWith<ZIssueMaxExceeded> get copyWith =>
      _$ZIssueMaxExceededCopyWithImpl<ZIssueMaxExceeded>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ZIssueMaxExceeded &&
...
class ZIssueParseFail extends ZIssue {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ZIssueParseFailCopyWith<ZIssueParseFail> get copyWith =>
      _$ZIssueParseFailCopyWithImpl<ZIssueParseFail>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ZIssueParseFail &&
  ...
  $Res call({
    ...
    return _then(ZIssueParseFail(
      ...
      val: freezed == val
          ...
          : val // ignore: cast_nullable_to_non_nullable
              as dynamic,
      throwable: freezed == throwable ? _self.throwable : throwable,
      rawPath: null == rawPath
          ? _self.rawPath
          : rawPath // ignore: cast_nullable_to_non_nullable
              as ZPath,
...
class ZIssueMissingValue extends ZIssue {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ZIssueMissingValueCopyWith<ZIssueMissingValue> get copyWith =>
      _$ZIssueMissingValueCopyWithImpl<ZIssueMissingValue>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ZIssueMissingValue &&
            (identical(other.rawPath, rawPath) || other.rawPath == rawPath) &&
            const DeepCollectionEquality().equals(other.throwable, throwable));
  }
