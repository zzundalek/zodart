...
/// Adds pattern-matching-related methods to [Ctor].
extension CtorPatterns on Ctor {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( NamedCtor value)?  namedCtor,TResult Function( UnnamedCtor value)?  unnamedCtor,required TResult orElse(),}){
final _that = this;
switch (_that) {
case NamedCtor() when namedCtor != null:
return namedCtor(_that);case UnnamedCtor() when unnamedCtor != null:
return unnamedCtor(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( NamedCtor value)  namedCtor,required TResult Function( UnnamedCtor value)  unnamedCtor,}){
final _that = this;
switch (_that) {
case NamedCtor():
return namedCtor(_that);case UnnamedCtor():
return unnamedCtor(_that);}
}
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( NamedCtor value)?  namedCtor,TResult? Function( UnnamedCtor value)?  unnamedCtor,}){
final _that = this;
switch (_that) {
case NamedCtor() when namedCtor != null:
return namedCtor(_that);case UnnamedCtor() when unnamedCtor != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String name,  bool isConst,  bool isFactory,  Map<String, Reference> reqNamedParams,  Map<String, Reference> optNamedParams,  List<Reference> reqPositionalParams,  List<Reference> optPositionalParams)?  namedCtor,TResult Function( bool isConst,  bool isFactory,  Map<String, Reference> reqNamedParams,  Map<String, Reference> optNamedParams,  List<Reference> reqPositionalParams,  List<Reference> optPositionalParams)?  unnamedCtor,required TResult orElse(),}) {final _that = this;
switch (_that) {
case NamedCtor() when namedCtor != null:
return namedCtor(_that.name,_that.isConst,_that.isFactory,_that.reqNamedParams,_that.optNamedParams,_that.reqPositionalParams,_that.optPositionalParams);case UnnamedCtor() when unnamedCtor != null:
return unnamedCtor(_that.isConst,_that.isFactory,_that.reqNamedParams,_that.optNamedParams,_that.reqPositionalParams,_that.optPositionalParams);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String name,  bool isConst,  bool isFactory,  Map<String, Reference> reqNamedParams,  Map<String, Reference> optNamedParams,  List<Reference> reqPositionalParams,  List<Reference> optPositionalParams)  namedCtor,required TResult Function( bool isConst,  bool isFactory,  Map<String, Reference> reqNamedParams,  Map<String, Reference> optNamedParams,  List<Reference> reqPositionalParams,  List<Reference> optPositionalParams)  unnamedCtor,}) {final _that = this;
switch (_that) {
case NamedCtor():
return namedCtor(_that.name,_that.isConst,_that.isFactory,_that.reqNamedParams,_that.optNamedParams,_that.reqPositionalParams,_that.optPositionalParams);case UnnamedCtor():
return unnamedCtor(_that.isConst,_that.isFactory,_that.reqNamedParams,_that.optNamedParams,_that.reqPositionalParams,_that.optPositionalParams);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String name,  bool isConst,  bool isFactory,  Map<String, Reference> reqNamedParams,  Map<String, Reference> optNamedParams,  List<Reference> reqPositionalParams,  List<Reference> optPositionalParams)?  namedCtor,TResult? Function( bool isConst,  bool isFactory,  Map<String, Reference> reqNamedParams,  Map<String, Reference> optNamedParams,  List<Reference> reqPositionalParams,  List<Reference> optPositionalParams)?  unnamedCtor,}) {final _that = this;
switch (_that) {
case NamedCtor() when namedCtor != null:
return namedCtor(_that.name,_that.isConst,_that.isFactory,_that.reqNamedParams,_that.optNamedParams,_that.reqPositionalParams,_that.optPositionalParams);case UnnamedCtor() when unnamedCtor != null:
return unnamedCtor(_that.isConst,_that.isFactory,_that.reqNamedParams,_that.optNamedParams,_that.reqPositionalParams,_that.optPositionalParams);case _:
