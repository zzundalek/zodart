...
class ZTypeConverter {
  ...
  ///
  /// Throws an [UnsupportedError] if the type is not a supported ZodArt type.
  static Reference getTypeReference(DartType dartType) {
    final match = converters.firstWhere(
      ...
      orElse: () => throw UnsupportedError("@ZodArt schema - '$dartType' is not supported by ZTypeConverter."),
    );
